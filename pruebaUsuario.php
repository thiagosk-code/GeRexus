...
<body>
    ...
    require_once (__DIR__ . '/../../Logica/LogicaCondicion.php');
    ...
    if (isset($_POST['nom']) && isset($_POST['email']) && isset($_POST['contra'])) {
        ...
        $CDTO = new CondicionDTO(200, "nombre", "descripcion", 100);

        $facha = new FachadaLogica();
        $res = $facha->retornoILogicaUsuario()->altaUsuarioL($uDTO);
        $resCondicion = $facha->retornoILogicaCondicion()->modificarCondicionL($CDTO);
        if ($res === true) {
            print "<br><strong>Alta dada con éxito.</strong><br>";
        } else {
            print "<br><strong>Error - no se pudo dar de alta.</strong><br>";
        }
        if ($resCondicion === true) {
            print "<br><strong>Alta dada con éxito. CONDICION AAA</strong><br>";
        } else {
            print "<br><strong>Error - no se pudo dar de alta. CONDICION AAA</strong><br>";
        }
    }
    ?>
